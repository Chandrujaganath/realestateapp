...
import { Calendar, Clock, MoreHorizontal, AlertCircle, CheckCircle2, XCircle, PauseCircle, AlertTriangle } from "lucide-react";
      ...
      {showCommentInput && (
        <CardFooter className="flex flex-col p-4 pt-0 gap-2">
          ...
          <div className="flex justify-end gap-2 w-full">
            ...
            <Button 
              size="sm" 
              onClick={() => handleStatusUpdate(task.status === "completed" ? "in_progress" : "completed")}
              disabled={isSubmitting}
            >
