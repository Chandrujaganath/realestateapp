...
export class FirebaseService {
   ...
   */
  protected getDocRef<T = DocumentData>(
   ...
   */
  protected async addDoc<T extends DocumentData>(collectionPath: string, data: T): Promise<string> {
   ...
   * Delete a document
   */
  protected async deleteDoc(collectionPath: string, docId: string): Promise<void> {
    const docRef = this.getDocRef(collectionPath, docId);
   ...
   */
  protected async getDocById<T>(collectionPath: string, docId: string): Promise<T | null> {
  ...
  protected async queryDocs<T>(
    ...
    const _q = query(colRef, ...constraints);
