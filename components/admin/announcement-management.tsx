...
export function AnnouncementManagement() {
  ...
  const _handleEdit = (announcement: Announcement) => {
  ...
  const _handleDelete = async () => {
    ...
    setIsDeleting(true);
    const _success = await deleteAnnouncement(selectedAnnouncement.id);
    setIsDeleting(false);
  ...
  const _openDeleteDialog = (announcement: Announcement) => {
    setSelectedAnnouncement(announcement);
    setIsDeleteDialogOpen(true);
  };

  const _getPriorityIcon = (priority: Announcement['priority']) => {
    switch (priority) {
      case 'high':
  ...
  const _getPriorityColor = (priority: Announcement['priority']) => {
    switch (priority) {
      case 'high':
