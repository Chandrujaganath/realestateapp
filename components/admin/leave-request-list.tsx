...
const LeaveRequestList = () => {
  ...
  let brevity: any // Replace 'any' with the actual type if known
  let it: any // Replace 'any' with the actual type if known
  let is: any // Replace 'any' with the actual type if known
  let correct: any // Replace 'any' with the actual type if known
  let and: any // Replace 'any' with the actual type if known
