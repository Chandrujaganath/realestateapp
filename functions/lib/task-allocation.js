...
exports.assignSellRequestToManager = functions.firestore
    ...
    try {
        ...
        return db.runTransaction(async (transaction) => {
            ...
            const managers = managersSnapshot.docs.map((doc) => (Object.assign({ id: doc.id }, doc.data())));
            ...
            const nextIndex = ((queueData === null || queueData === void 0 ? void 0 : queueData.lastIndex) + 1) % managers.length;
...
exports.assignVisitRequestToManager = functions.firestore
    ...
    if ((visitData === null || visitData === void 0 ? void 0 : visitData.assignedManagerId) || (visitData === null || visitData === void 0 ? void 0 : visitData.status) !== "pending") {
        return null;
    }
    try {
