...
exports.sendPushNotification = functions.firestore.onDocumentCreated("notifications/{notificationId}", async (event) => {
    try {
        ...
        const payload = {
            ...
            data: Object.assign(Object.assign(Object.assign({ type }, data), (referenceId ? { referenceId } : {})), { click_action: "FLUTTER_NOTIFICATION_CLICK" }),
        };
