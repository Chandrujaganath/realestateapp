...
import { Plugin as _Plugin_2 } from 'pretty-format';
import { Plugins } from 'pretty-format';
import type { PrettyFormatOptions } from 'pretty-format';

export declare const _addSerializer: (plugin: Plugin_2) => void;

export declare const _buildSnapshotResolver: (
  config: Config.ProjectConfig,
  localRequire?: Promise<LocalRequire> | LocalRequire
) => Promise<SnapshotResolver>;

export declare const _cleanup: (
...
export declare const _getSerializers: () => Plugins;

export declare const _isSnapshotPath: (path: string) => boolean;
...
export declare const _toThrowErrorMatchingInlineSnapshot: MatcherFunctionWithContext<
  Context,
  [inlineSnapshot?: string, fromPromise?: boolean]
>;

export declare const _toThrowErrorMatchingSnapshot: MatcherFunctionWithContext<
  Context,
