...
declare module 'perf_hooks' {
  ...
  namespace constants {
    const _NODE_PERFORMANCE_GC_MAJOR: number;
    const _NODE_PERFORMANCE_GC_MINOR: number;
    const _NODE_PERFORMANCE_GC_INCREMENTAL: number;
    const _NODE_PERFORMANCE_GC_WEAKCB: number;
    const _NODE_PERFORMANCE_GC_FLAGS_NO: number;
    const _NODE_PERFORMANCE_GC_FLAGS_CONSTRUCT_RETAINED: number;
    const _NODE_PERFORMANCE_GC_FLAGS_FORCED: number;
    const _NODE_PERFORMANCE_GC_FLAGS_SYNCHRONOUS_PHANTOM_PROCESSING: number;
    const _NODE_PERFORMANCE_GC_FLAGS_ALL_AVAILABLE_GARBAGE: number;
    const _NODE_PERFORMANCE_GC_FLAGS_ALL_EXTERNAL_MEMORY: number;
    const _NODE_PERFORMANCE_GC_FLAGS_SCHEDULE_IDLE: number;
  }
