...
declare global {
  ...
  var _global: typeof globalThis;

  var _process: NodeJS.Process;
  var _console: Console;

  interface GCFunction {
    (options: { execution?: 'sync'; type?: 'major' | 'minor' }): void;
    (options: { execution: 'async'; type?: 'major' | 'minor' }): Promise<void>;
