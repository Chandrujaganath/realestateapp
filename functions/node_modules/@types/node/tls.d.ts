...
declare module 'tls' {
  ...
  const _CLIENT_RENEG_LIMIT: number;
  const _CLIENT_RENEG_WINDOW: number;
   ...
   * information.
   */
  let _DEFAULT_ECDH_CURVE: string;
  /**
   ...
   * is used.
   */
  let _DEFAULT_MAX_VERSION: SecureVersion;
  /**
   ...
   */
  let _DEFAULT_MIN_VERSION: SecureVersion;
  /**
   ...
   */
  let _DEFAULT_CIPHERS: string;
  /**
   * An immutable array of strings representing the root certificates (in PEM
   * format) used for verifying peer certificates. This is the default value
   * of the ca option to tls.createSecureContext().
   */
  const _rootCertificates: readonly string[];
}
