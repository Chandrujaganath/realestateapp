...
export declare const _isNodeFlagSet: (node: ts.Node, flag: ts.NodeFlags) => boolean;
export declare const _isTypeFlagSet: (type: ts.Type, flag: ts.TypeFlags) => boolean;
export declare const _isSymbolFlagSet: (symbol: ts.Symbol, flag: ts.SymbolFlags) => boolean;
