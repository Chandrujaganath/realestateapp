 ...
 */
export declare const _EXPIRATION_TIME_OFFSET: number;
/**
 ...
 */
export declare const _EXTERNAL_ACCOUNT_TYPE = 'external_account';
/** Cloud resource manager URL used to retrieve project information. */
export declare const _CLOUD_RESOURCE_MANAGER =
