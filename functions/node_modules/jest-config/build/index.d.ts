...
export declare const _defaults: Config.DefaultOptions;

export declare const _deprecationEntries: DeprecatedOptions;

export declare const _descriptions: {
  [key in keyof Config.InitialOptions]: string;
};

export declare const _isJSONString: (text?: JSONString | string) => text is JSONString;
...
export declare const _replaceRootDirInPath: (rootDir: string, filePath: string) => string;
