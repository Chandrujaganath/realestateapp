 ...
 */
export declare const _resolveRunner: (
...
export declare const _resolveSequencer: (
  resolver: string | undefined | null,
  {
    filePath,
    rootDir,
 ...
 * 1. looks for <name> relative to Jest.
 */
export declare const _resolveTestEnvironment: ({
  rootDir,
 ...
 * 1. looks for <name> relative to Jest.
 */
export declare const _resolveWatchPlugin: (
  resolver: string | undefined | null,
  {
    filePath,
    rootDir,
