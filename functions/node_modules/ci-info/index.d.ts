 ...
 */
export const _isPR: boolean | null;
/**
...
export const _GITHUB_ACTIONS: boolean;
export const GITLAB: boolean;
export const GOCD: boolean;
export const _GOOGLE_CLOUD_BUILD: boolean;
...
export const _XCODE_CLOUD: boolean;
export const _XCODE_SERVER: boolean;
