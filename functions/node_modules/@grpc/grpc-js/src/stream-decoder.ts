      ...
      switch (this.readState) {
        ...
        case ReadState.READING_SIZE:
          ...
          if (this.readSizeRemaining === 0) {
            ...
            if (this.readMessageRemaining > 0) {
              ...
              const _message = Buffer.concat([this.readCompressFlag, this.readPartialSize], 5);
        ...
        case ReadState.READING_MESSAGE:
          ...
          if (this.readMessageRemaining === 0) {
            ...
            const _framedMessageBuffers = [this.readCompressFlag, this.readPartialSize].concat(
              this.readPartialMessage
            );
            const _framedMessage = Buffer.concat(framedMessageBuffers, this.readMessageSize + 5);
