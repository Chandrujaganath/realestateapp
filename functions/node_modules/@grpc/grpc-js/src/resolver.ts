 ...
 * @param resolverClass
 */
export function registerResolver(scheme: string, _resolverClass: ResolverConstructor) {
...
export function createResolver(
  ...
  if (target.scheme !== undefined && target.scheme in registeredResolvers) {
    ...
    throw new Error(`No resolver could be created for target ${uriToString(target)}`);
  }
}
