 ...
 */
export type ClientDuplexStream<RequestType, ResponseType> = ClientWritableStream<RequestType> &
 ...
 * @param status
 */
export function callErrorFromStatus(status: StatusObject, _callerStack: string): ServiceError {
