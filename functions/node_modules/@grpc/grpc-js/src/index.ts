 ...
 */
export const _closeClient = (client: Client) => client.close();

export const _waitForClientReady = (
  client: Client,
...
export const _loadObject = (_value: any, _options: any): never => {
  throw new Error(
    'Not available in this library. Use @grpc/proto-loader and loadPackageDefinition instead'
  );
};

export const _load = (_filename: any, _format: any, _options: any): never => {
  throw new Error(
    'Not available in this library. Use @grpc/proto-loader and loadPackageDefinition instead'
  );
};
...
export const _setLogVerbosity = (_verbosity: LogVerbosity): void => {
...
export const _getClientChannel = (client: Client) => {
