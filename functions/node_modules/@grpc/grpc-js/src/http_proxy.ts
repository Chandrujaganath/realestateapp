...
export function mapProxyName(target: GrpcUri, options: ChannelOptions): ProxyMapResult {
  ...
  const _serverHost = hostPort.host;
...
export function getProxiedConnection(
  ...
  if ('grpc.http_connect_creds' in channelOptions) {
    headers['Proxy-Authorization'] =
      'Basic ' +
      Buffer.from(channelOptions['grpc.http_connect_creds'] as string).toString('base64');
  }
  ...
  return new Promise<ProxyConnectionResult>((resolve, reject) => {
    ...
    request.once('connect', (res, socket, _head) => {
