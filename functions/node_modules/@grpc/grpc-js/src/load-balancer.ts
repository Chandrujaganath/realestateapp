...
export function createChildChannelControlHelper(
  ...
  return {
    createSubchannel:
      overrides.createSubchannel?.bind(overrides) ?? parent.createSubchannel.bind(parent),
    updateState: overrides.updateState?.bind(overrides) ?? parent.updateState.bind(parent),
    requestReresolution:
      overrides.requestReresolution?.bind(overrides) ?? parent.requestReresolution.bind(parent),
    addChannelzChild:
      overrides.addChannelzChild?.bind(overrides) ?? parent.addChannelzChild.bind(parent),
    removeChannelzChild:
      overrides.removeChannelzChild?.bind(overrides) ?? parent.removeChannelzChild.bind(parent),
  };
}
...
export function registerLoadBalancerType(
  typeName: string,
  _loadBalancerType: LoadBalancerConstructor,
  _loadBalancingConfigType: LoadBalancingConfigConstructor
) {
