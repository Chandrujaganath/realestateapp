...
declare const _CHANNEL_SYMBOL: unique symbol;
declare const _INTERCEPTOR_SYMBOL: unique symbol;
declare const _INTERCEPTOR_PROVIDER_SYMBOL: unique symbol;
declare const _CALL_INVOCATION_TRANSFORMER_SYMBOL: unique symbol;
