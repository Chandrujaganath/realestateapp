...
export { OAuth2Client };
/**** Client Credentials ****/
export declare const _credentials: {
  /**
 ...
 */
export declare const _closeClient: (client: Client) => void;
export declare const _waitForClientReady: (
  client: Client,
...
export declare const _loadObject: (value: any, options: any) => never;
export declare const _load: (filename: any, format: any, options: any) => never;
export declare const _setLogger: (logger: Partial<Console>) => void;
export declare const _setLogVerbosity: (verbosity: LogVerbosity) => void;
export { Server };
export { ServerCredentials };
export { KeyCertPair };
export declare const _getClientChannel: (client: Client) => Channel;
