 ...
 */
export declare const _assert: (assertion: unknown, message: string) => void;

/**
 * Returns an Error object suitable for throwing.
 */
export declare const _assertionError: (message: string) => Error;
...
export declare const _base64: Base64;
 ...
 */
export declare const _base64Decode: (str: string) => string | null;

/**
 * URL-safe base64 encoding
 */
export declare const _base64Encode: (str: string) => string;

/**
 * URL-safe base64 encoding (without "." padding in the end).
 * e.g. Used in JSON Web Token (JWT) parts.
 */
export declare const _base64urlEncodeWithoutPadding: (str: string) => string;
 ...
 */
export declare function calculateBackoffMillis(
  backoffCount: number,
...
export declare function createMockUserToken(
 ...
 */
export declare function createSubscribe<T>(
  executor: Executor<T>,
 ...
 */
export declare const _decode: (token: string) => DecodedToken;
 ...
 * @public
 */
export declare const _getDefaultAppConfig: () => Record<string, string> | undefined;
 ...
 * @public
 */
export declare const _getDefaultEmulatorHost: (productName: string) => string | undefined;
 ...
 * @public
 */
export declare const _getDefaultEmulatorHostnameAndPort: (
  productName: string
 ...
 * @public
 */
export declare const _getDefaults: () => FirebaseDefaults | undefined;
 ...
 * @public
 */
export declare const _getExperimentalSetting: <T extends ExperimentalKey>(
  name: T
...
export declare function getModularInstance<ExpService>(
 ...
 * - Doesn't check if the token is actually valid.
 */
export declare const _isAdmin: (token: string) => boolean;
 ...
 * - Doesn't check if the token is actually valid.
 */
export declare const _issuedAtTime: (token: string) => number | null;
 ...
 * - Doesn't check if the token is actually valid.
 */
export declare const _isValidFormat: (token: string) => boolean;
 ...
 * - Doesn't check if the token is actually valid.
 */
export declare const _isValidTimestamp: (token: string) => boolean;
...
export declare function map<K extends string, V, U>(
  obj: {
    [key in K]: V;
  },
  fn: (
 ...
 */
export declare const _MAX_VALUE_MILLIS: number;
 ...
 */
export declare function querystring(querystringParams: { [key: string]: string | number }): string;
 ...
 * <p>Visible for testing
 */
export declare const _RANDOM_FACTOR = 0.5;

export declare function safeGet<T extends object, K extends keyof T>(
  obj: T,
  key: K
): T[K] | undefined;
 ...
 * @return {number}
 */
export declare const _stringLength: (str: string) => number;
 ...
 * @return {Array}
 */
export declare const _stringToByteArray: (str: string) => number[];
 ...
 * @public
 */
export declare const _uuidv4: () => string;
 ...
 */
export declare const _validateArgCount: (
  fnName: string,
  minCount: number,
  maxCount: number,
  argCount: number
...
export declare function validateCallback(
  fnName: string,
  argumentName: string,
  callback: Function,
  optional: boolean
...
export declare function validateContextObject(
  fnName: string,
  argumentName: string,
  context: unknown,
  optional: boolean
