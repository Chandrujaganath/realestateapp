...
export declare const _TEST_PROJECT: any;
export declare function getFreshRepo(path: Path): DatabaseReference;
export declare const _DATABASE_ADDRESS: any;
export declare const _DATABASE_URL: any;
...
export declare function writeAndValidate(
  writerRef: DatabaseReference,
  readerRef: DatabaseReference,
  toWrite: unknown,
  ec: EventAccumulator
