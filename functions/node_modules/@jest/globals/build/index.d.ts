...
export declare const _expect: JestExpect;
export declare const _it: Global.GlobalAdditions['it'];
export declare const _test: Global.GlobalAdditions['test'];
export declare const _fit: Global.GlobalAdditions['fit'];
export declare const _xit: Global.GlobalAdditions['xit'];
export declare const _xtest: Global.GlobalAdditions['xtest'];
export declare const _describe: Global.GlobalAdditions['describe'];
export declare const _xdescribe: Global.GlobalAdditions['xdescribe'];
export declare const _fdescribe: Global.GlobalAdditions['fdescribe'];
export declare const _beforeAll: Global.GlobalAdditions['beforeAll'];
export declare const _beforeEach: Global.GlobalAdditions['beforeEach'];
export declare const _afterEach: Global.GlobalAdditions['afterEach'];
export declare const _afterAll: Global.GlobalAdditions['afterAll'];
