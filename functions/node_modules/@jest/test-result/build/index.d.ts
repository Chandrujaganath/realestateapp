...
export declare const _addResult: (
...
export declare const _buildFailureTestResult: (
  testPath: string,
...
export declare const _createEmptyTestResult: () => TestResult;
...
export declare const _makeEmptyAggregatedTestResult: () => AggregatedResult;

export declare interface RuntimeTransformResult extends TransformTypes.TransformResult {
...
export declare type TestFileEvent<T extends keyof TestEvents = keyof TestEvents> = (
  eventName: T,
  args: TestEvents[T]
) => unknown;
