 ...
 */
export declare const _SUPPORTED_REGIONS: readonly [
  'us-central1',
  'us-east1',
  'us-east4',
  'us-west2',
 ...
 */
export declare const _MIN_TIMEOUT_SECONDS = 0;
/**
 * Cloud Functions max timeout value.
 */
export declare const _MAX_TIMEOUT_SECONDS = 540;
/**
 * List of available memory options supported by Cloud Functions.
 */
export declare const _VALID_MEMORY_OPTIONS: readonly [
  '128MB',
  '256MB',
  '512MB',
  '1GB',
 ...
 */
export declare const _VPC_EGRESS_SETTINGS_OPTIONS: readonly [
 ...
 */
export declare const _INGRESS_SETTINGS_OPTIONS: readonly [
...
export declare const _DEFAULT_FAILURE_POLICY: FailurePolicy;
export declare const _MAX_NUMBER_USER_LABELS = 58;
/**
