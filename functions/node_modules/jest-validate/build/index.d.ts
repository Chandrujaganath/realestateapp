...
export declare const _createDidYouMeanMessage: (
  unrecognized: string,
...
export declare const _format: (value: unknown) => string;

export declare const _logValidationWarning: (
  name: string,
  message: string,
  comment?: string | null
) => void;
...
export declare const _validate: (
