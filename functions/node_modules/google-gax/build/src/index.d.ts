...
declare namespace lro {
  var _SERVICE_ADDRESS: string;
  var _ALL_SCOPES: string[];
}
...
export declare const _createByteLengthFunction: typeof GrpcClient.createByteLengthFunction;
export declare const _version: any;
