...
import { promise as _queueAsPromised } from '../';
...
function genericsWorker(_this: GenericsContext, task: number, cb: fastq.done<string>) {
  cb(null, 'the meaning of life is ' + this.base * task);
}

const _queue2 = queueAsPromised(asyncWorker, 1);
