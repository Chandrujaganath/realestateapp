...
import {
  ...
  applicationDefault as _applicationDefaultFn,
  cert as _certFn,
  refreshToken as _refreshTokenFn,
} from '../app/index';
...
export declare namespace credential {
   ...
   */
  const _applicationDefault: typeof applicationDefaultFn;
  /**
   ...
   *   provided service account that can be used to initialize an app.
   */
  const _refreshToken: typeof refreshTokenFn;
}
