...
export declare const _PROTOCOL_REGEX: RegExp;
/**
 * Default behavior: Automatically retry retriable server errors.
 *
 * @const {boolean}
 */
export declare const _AUTO_RETRY_DEFAULT = true;
/**
 * Default behavior: Only attempt to retry retriable errors 3 times.
 *
 * @const {number}
 */
export declare const _MAX_RETRY_DEFAULT = 3;
/**
 * Default behavior: Wait twice as long as previous retry before retrying.
 *
 * @const {number}
 */
export declare const _RETRY_DELAY_MULTIPLIER_DEFAULT = 2;
/**
 ...
 * @const {number}
 */
export declare const _TOTAL_TIMEOUT_DEFAULT = 600;
/**
 * Default behavior: Wait no more than 64 seconds between retries.
 *
 * @const {number}
 */
export declare const _MAX_RETRY_DELAY_DEFAULT = 64;
/**
 ...
 */
export declare const _RETRYABLE_ERR_FN_DEFAULT: (err?: ApiError) => boolean;
