 ...
 */
export declare const _REFERENCE_NAME_MIN_ID = '__id-9223372036854775808__';
/*!
 ...
 */
export declare const _RECURSIVE_DELETE_MAX_PENDING_OPS = 5000;
/*!
 ...
 */
export declare const _RECURSIVE_DELETE_MIN_PENDING_OPS = 1000;
/**
...
export declare class RecursiveDelete {
  ...
  constructor(
    firestore: Firestore,
    writer: BulkWriter,
    ref: firestore.CollectionReference<unknown> | firestore.DocumentReference<unknown>,
    maxLimit: number,
    minLimit: number
  );
  /**
