 ...
 * @private
 */
export declare const _MAX_REQUEST_RETRIES = 5;
/**
 * The maximum number of times to attempt a transaction before failing.
 * @private
 */
export declare const _DEFAULT_MAX_TRANSACTION_ATTEMPTS = 5;
/**
...
export declare class Firestore implements firestore.Firestore {
   ...
   */
  getAll<T>(
    ...documentRefsOrReadOptions: Array<firestore.DocumentReference<T> | firestore.ReadOptions>
