 ...
 */
export declare const _CLIENT_TERMINATED_ERROR_MSG = 'The client has already been terminated';
/**
...
export declare class ClientPool<T> {
  ...
  constructor(
    ...
    clientFactory: (requiresGrpc: boolean) => T,
    clientDestructor?: (client: T) => Promise<void>
  );
  /**
