 ...
 */
export declare const _RETRY_MAX_BATCH_SIZE = 10;
/*!
 ...
 */
export declare const _DEFAULT_INITIAL_OPS_PER_SECOND_LIMIT = 500;
/*!
 ...
 * https://firebase.google.com/docs/firestore/best-practices#ramping_up_traffic.
 */
export declare const _DEFAULT_MAXIMUM_OPS_PER_SECOND_LIMIT = 10000;
/*!
 ...
 */
export declare const _DEFAULT_JITTER_FACTOR = 0.3;
/**
...
declare class BulkWriterOperation {
  ...
  constructor(
    ...
    sendFn: (op: BulkWriterOperation) => void,
    errorFn: (error: BulkWriterError) => boolean,
    successFn: (ref: firestore.DocumentReference<unknown>, result: WriteResult) => void
  );
...
declare class BulkCommitBatch extends WriteBatch {
  ...
  bulkCommit(options?: { requestTag?: string }): Promise<void>;
  /**
