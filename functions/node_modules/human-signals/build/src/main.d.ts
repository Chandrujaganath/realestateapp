 ...
 */
export declare const _signalsByName: { [signalName: string]: Signal };
/**
 * Object whose keys are signal numbers and values are signal objects.
 */
export declare const _signalsByNumber: { [signalNumber: string]: Signal };

export declare type SignalAction = 'terminate' | 'core' | 'ignore' | 'pause' | 'unpause';
export declare type SignalStandard = 'ansi' | 'posix' | 'bsd' | 'systemv' | 'other';
