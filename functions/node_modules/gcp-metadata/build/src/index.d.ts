...
export declare const _BASE_PATH = '/computeMetadata/v1';
export declare const _HOST_ADDRESS = 'http://169.254.169.254';
export declare const _SECONDARY_HOST_ADDRESS = 'http://metadata.google.internal.';
export declare const _HEADER_NAME = 'Metadata-Flavor';
export declare const _HEADER_VALUE = 'Google';
 ...
 */
export declare const _METADATA_SERVER_DETECTION: Readonly<{
 ...
 */
export declare let _gcpResidencyCache: boolean | null;
/**
