...
declare const _TS_ESLINT_PARSER = '@typescript-eslint/parser';
type RuleTesterConfig = Pick<
  BaseRuleTester.RuleTesterConfig,
  Exclude<keyof BaseRuleTester.RuleTesterConfig, 'parser'>
> & {
