...
export type NamedCreateRuleMetaDocs = Pick<
  RuleMetaDataDocs,
  Exclude<keyof RuleMetaDataDocs, 'url'>
>;
...
>({
  ...
  meta,
  ...rule
}: Readonly<RuleWithMetaAndName<TOptions, TMessageIds, TRuleListener>>) => RuleModule<
  TMessageIds,
  TOptions,
  TRuleListener
>;
export declare namespace RuleCreator {
  var _withoutDocs: typeof createRule;
}
/**
