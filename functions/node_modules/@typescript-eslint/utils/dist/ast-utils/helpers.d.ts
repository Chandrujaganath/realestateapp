...
export declare const _isNodeOfType: <NodeType extends AST_NODE_TYPES>(
  nodeType: NodeType
  ...
  | Extract<
    ...
    >;
export declare const _isNodeOfTypes: <NodeTypes extends readonly AST_NODE_TYPES[]>(
  nodeTypes: NodeTypes
) => (node: TSESTree.Node | null | undefined) => node is
  | Extract<
      TSESTree.AccessorPropertyComputedName,
  ...
  | Extract<
    ...
    >;
export declare const _isNodeOfTypeWithConditions: <
...
export declare const _isTokenOfTypeWithConditions: <
...
export declare const _isNotTokenOfTypeWithConditions: <
  TokenType extends AST_TOKEN_TYPES,
  ExtractedToken extends
    | Extract<
        TSESTree.BooleanToken,
...
>(
  ...
  | Exclude<TSESTree.BooleanToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.BlockComment, ExtractedToken & Conditions>
  | Exclude<TSESTree.LineComment, ExtractedToken & Conditions>
  | Exclude<TSESTree.IdentifierToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.JSXIdentifierToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.JSXTextToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.KeywordToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.NullToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.NumericToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.PunctuatorToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.RegularExpressionToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.StringToken, ExtractedToken & Conditions>
  | Exclude<TSESTree.TemplateToken, ExtractedToken & Conditions>;
