...
declare namespace SourceCode {
  ...
  type GetFilterPredicate<TFilter, TDefault> = TFilter extends ((
  ...
  type ReturnTypeFromOptions<T> = T extends {
    ...
    : GetFilterPredicateFromOptions<T, Exclude<TSESTree.Token, TSESTree.Comment>>;
...
declare const _SourceCode_base: typeof SourceCodeBase;
