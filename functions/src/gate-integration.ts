 ...
 */
export const verifyQRCode = functions.https.onCall(async (data: QRVerifyData, context: functions.https.CallableContext) => {
  try {
 ...
 */
export const validateVisitQR = functions.https.onCall(async (data: {qrCode: string}, context) => {
  try {
