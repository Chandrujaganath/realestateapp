...
export default function RegisterAsClientPage() {
  ...
  const handleClientRegistration = async (formData: ClientRegistrationFormData) => {
    try {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-4">
        <p>Already have an account? <a href="/auth/login" className="text-blue-500 hover:underline">Login</a></p>
      </div>
    </div>
  );
} 
