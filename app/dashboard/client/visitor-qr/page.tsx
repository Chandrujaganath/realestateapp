...
export default function VisitorQrPage() {
  ...
  useEffect(() => {
    const _checkActiveQr = async () => {
      const _hasActive = await hasActiveVisitorQr();
  ...
  const _handleGenerateQr = async () => {
    ...
    try {
      const _qrUrl = await generateVisitorQr(visitorName, visitorEmail, visitDate, selectedPlotId);
      setQrCodeUrl(qrUrl);
      setHasActiveQr(true);
    } catch (err: any) {
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Share this QR code with your visitor for site access
          </p>
        </div>
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Create a temporary QR code for a visitor to access your property
        </p>
      </div>
        ...
        <Card className="glass-card max-w-md mx-auto">
          <CardContent className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-center text-muted-foreground mb-6">
              You already have an active visitor pass. Only one visitor pass can be active at a
              time.
            </p>
            <Button
              variant="outline"
              className="glass-button"
              onClick={() => setHasActiveQr(false)}
            >
