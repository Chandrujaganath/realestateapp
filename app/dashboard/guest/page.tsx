    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="glass-card">
          ...
          <CardContent>
            <p className="text-sm mb-4">
              View our portfolio of properties and find the perfect match for your needs.
            </p>
            <Link href="/project">
        ...
        <Card className="glass-card">
          ...
          <CardContent>
            <p className="text-sm mb-4">
              View your upcoming visits, access QR codes, and check visit status.
            </p>
        ...
        <Card className="glass-card">
          ...
          <CardContent>
            <p className="text-sm mb-4">
              View interactive plot layouts and check availability in real-time.
            </p>
            <Link href="/plot">
      ...
      <Card className="glass-card">
        ...
        <CardContent className="space-y-4">
          <p>
            As a guest, you have access to browse our projects, view plot layouts, and schedule site
            visits. Your account is temporary and will be automatically deactivated after your
            visit.
          </p>
