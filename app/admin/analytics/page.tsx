    ...
    <div>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
            ...
            <Card className="col-span-4">
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <LineChart data={mockAnalytics.visitTrends}>
        ...
        <TabsContent value="visits" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Visit Request Status</CardTitle>
              <CardDescription>Current status of visit requests</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
        ...
        <TabsContent value="projects" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Views and inquiries by project</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={mockAnalytics.projectActivity}>
                  <CartesianGrid strokeDasharray="3 3" />
