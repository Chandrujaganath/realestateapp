...
import { CalendarIcon, MapPin, Building2, Clock, ArrowLeft } from "lucide-react"
    ...
    <div className="container max-w-2xl mx-auto py-8 px-4">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Schedule a visit to view your selected property
        </p>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={timeSlot} onValueChange={setTimeSlot}>
                <SelectTrigger 
                  className={cn(errors.timeSlot && "border-destructive")}
                >
