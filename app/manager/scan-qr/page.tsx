...
export default function ScanQrPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <Tabs defaultValue="visit" value={activeTab} onValueChange={(value) => {
                  ...
                  <AlertDescription>
                    <div className="mt-2 grid gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm">
                          <span className="font-medium">Visitor:</span> {scanResult.data?.name || "Unknown"}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <Clock className="h-4 w-4 text-muted-foreground" />
                        <p className="text-sm">
                          <span className="font-medium">Time:</span> {new Date(scanResult.data?.date || Date.now()).toLocaleTimeString()}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <CalendarClock className="h-4 w-4 text-muted-foreground" />
                        <p className="text-sm">
                          <span className="font-medium">Status:</span> {scanResult.data?.status || "Unknown"}
                        </p>
                      </div>
                    </div>
                  </AlertDescription>
                  ...
                  <AlertDescription>
                    <div className="mt-2 grid gap-2">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm">
                          <span className="font-medium">Plot:</span> {scanResult.data?.name || "Unknown"}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <User className="h-4 w-4 text-muted-foreground" />
                        <p className="text-sm">
                          <span className="font-medium">Owner:</span> {scanResult.data?.owner || "Not assigned"}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <Clock className="h-4 w-4 text-muted-foreground" />
